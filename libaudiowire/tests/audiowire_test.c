...
#define PACKET_SAMPLE_DURATION_MS 20
#define PACKET_SAMPLE_COUNT (PACKET_SAMPLE_DURATION_MS * SAMPLE_RATE / 1000)
#define BUFFER_SAMPLE_COUNT (8 * PACKET_SAMPLE_COUNT)
